...
my @ESLOGAN=("FSociety is here now !");
...
system "color a";
print "FSociety Tool ~ ADMIN Panel Finder By FSociety~            
$c[2] #$ESLOGAN[rand @ESLOGAN] $c[11]   
                                               ";
print "\n";
print $c[9]. " say Bismillah And Add Website Target $c[11]. ツ ";
print "\n";
print $c[9]. "Ex: www.Israel.com or www.Isreal.com/path";
print "\n";
print "\n";
print $c[5]. " -> ";
$address=<STDIN>;
